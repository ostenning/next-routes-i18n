  ...
  return (
    <div className="links">
      ...
      <div>
        ...
        <Link href="main" locale={locale} params={{ something: 'else', id: '23' }} passHref><a className="test">- Main</a></Link>
      </div>
      ...
      <div>
        ...
        <button onClick={() => Router.pushRoute('main', { id: '23' }, locale, { shallow: false })}>Main</button>
      </div>
    </div>
  );
};
